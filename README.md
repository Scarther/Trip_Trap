...
1) ***stego_hunt.py*** takes an image file and turns into a stegnography driven tripwires out of media photos
2) ***triptrap.py*** takes already created files and turns them into a tripwire.
